...
(function(){
  ...
  function installStyles(){
    ...
    const s=document.createElement("style");s.id="myScheduleStyles";s.textContent=`
      #myScheduleTopButton{background:#0f766e!important;border-color:#0f766e!important;color:#fff!important;font-weight:700}
      .my-schedule-toolbar{display:grid;grid-template-columns:minmax(220px,1fr) auto;gap:9px;align-items:end;margin-bottom:14px}
      .my-schedule-tabs{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:14px}
      .my-schedule-tab{border:1px solid #cbd5e1;background:#fff;color:#334155;border-radius:7px;padding:8px 12px;font-weight:750;cursor:pointer}
      .my-schedule-tab.active{background:#17365d;color:#fff;border-color:#17365d}
      .my-schedule-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-bottom:14px}
      .my-summary-card{background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px}
      .my-summary-card strong{display:block;color:#17365d;font-size:18px}.my-summary-card span{font-size:11px;color:#64748b}
      .my-date-card{border:1px solid #e2e8f0;background:#fff;border-radius:9px;padding:12px;margin-bottom:8px}
      .my-date-head{display:flex;justify-content:space-between;gap:8px;align-items:flex-start;flex-wrap:wrap}
      .my-date-title{font-weight:800;color:#17365d}.my-date-site{font-size:12px;color:#64748b;margin-top:2px}
      .my-code-badge{display:inline-flex;align-items:center;justify-content:center;min-width:40px;border-radius:999px;background:#e0f2fe;color:#075985;padding:4px 9px;font-weight:800;font-size:12px}
